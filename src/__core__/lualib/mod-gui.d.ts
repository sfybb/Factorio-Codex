...
declare module "__core__.lualib.mod-gui" {
    export function get_frame_flow(player: FactorioRuntime.LuaPlayer): FactorioRuntime.FrameGuiElement;

    export function get_button_flow(player: FactorioRuntime.LuaPlayer): FactorioRuntime.FlowGuiElement;
