...
import {GuiStyle} from "factorio:prototype";

declare let data: PrototypeData

let prefix = "fcodex_"
let styles = data.raw["gui-style"].default as GuiStyle
...
styles[prefix + "quick_search_label"] = {
    type: "label_style",
    parent: "label",
    font: "fcodex_quick_search_inp_font",
...
data.extend([
    {
        ...
        type: "font",
        name: "fcodex_quick_search_inp_font",
        from: "default",
        size: 24
    }, { // This style is included for compatibility. Since it was once used,
    // it cannot be removed without crashing some games because of missing fonts
        type: "font",
        name: "fcodex_quic_search_inp_font",
        from: "default",
        size: 24
    }, { // TODO remove sprites sometime later
        type: "sprite",
